        ...
        if output_folder_path:
            try:
                ...
                if self.export_type.get() != 3: # i.e. if anything other than update pose images:
                    ...
                    temp_json_data = {"selected_layers": selected_layers, "unique_only": self.unique_pose_images_only.get(), "data": self.json_data, "path": output_folder_path}
                else:
                    new_image_paths = []
                    ...
                    temp_json_data = {"new_image_paths": new_image_paths, "data": self.json_data, "path": output_folder_path}
