...
class Menu_LayerSelect(tk.Frame):
    ...
    def setup_ui(self, change_menu_callback, load_path = None):
        ...
        # TODO Take another look at this canvas stuff, try to restructure in a more intuitive way if possible
...
- Preset: Use a valid .json file that contains pose data (i.e., one generated with the "Generate Sheet Data..." button) to search for poses in already-known locations.
        ...
        # When both rotated is selected, flip_v is redundant and therefore disabled for clarity
...
- None: No extra automatic padding is applied. (Recommended if using the "Custom padding" option.)
        ...
        # checkboxes and entries and such TODO better comment
    ...
    def redraw_layer_card(self, layer_index):
        ...
        gui_shared.bind_event_to_all_children(card_frame, "<MouseWheel>", self._on_left_frame_mousewheel)
    ...
    def update_preview_image(self):
        ...
        if self.image_size != None:
            ...
            # Getting here requires that no images are present in any layer
    ...
    def format_layer_json(self, json_type = "layerselect_save_json"):
        ...
        if search_type == "Border":
            ...
            # I mean... it MIGHT be better to try/except here. since ALL of the export funcs use this. idk. might be better
            search_type_data.update({
                "border_color": None,
